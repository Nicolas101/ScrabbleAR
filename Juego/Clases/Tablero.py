...
def crear_tablero(bolsa_fichas):
    ...
    casillas_especiales3 = {
        "x2":(('5-1','3-12','5-7','5-21','6-17','8-8','8-13','9-4','11-19','12-15','13-8','14-4','15-11','16-17','17-1','17-21','18-8','19-12'), "#2283BB"),
        "x3":(('3-11','4-2','4-20','5-6','5-16','7-12','9-8','10-3','10-19','11-15','14-8','15-5','15-12','15-17','18-2','18-9','18-13','18-20'), "#45BB22"),
        "-3":(('1-5','1-17','4-8','4-13','7-17','8-4','8-9','8-14','12-7','12-19','13-4','13-14','17-7','17-16','19-11','21-5','21-17'), '#F02121'),
        "-2":(('2-4','2-18','4-9','4-14','7-5','7-10','8-18','9-14','11-7','12-3','13-18','14-14','15-10','17-6','17-15','20-4','20-18'), '#F06C21'),
        "-1":(('3-3','3-10','3-19','5-15','6-5','7-11','9-18','10-7','10-15','11-3','14-9','14-13','14-18','16-5','18-14','19-3','19-10','19-19'), '#F0B121')
    }
    ...
    if num_random == 1:
        ...
        tamaño = 21
        tablero = Tablero(tamaño,casillas_especiales3,inicio=("11-11",bolsa_fichas.letras_random(1)[0]))#3
