def hacer_ventana(layout_tablero, layout_fichasJ, layout_fichasM,puntos_jug,puntos_ma,palabras_usuario,palabras_maquina,nivel,clases_validas):
    ...
    def armar_clases(nivel, clases, so):
        if so == 'w':
            if nivel == "-DIFICIL-":
                if "JJ" in clases:
    ...
    if os.access(r'Data\Images\Juego\Avatar-CPU.png',0):
        ...
        barra_datos = [
            ...
            [sg.Column(armar_clases(nivel, clases_validas, 'w'),background_color="#2781D3",pad=((5,0),(0,5)))],
        ...
        window = sg.Window("ScrabbleAR - En partida",size=(1000,600),background_color="#40B7C9",margins=(0,0)).Layout(layout)


    else:
                                                      ####LINUX######
        datos_cpu = [
            [sg.Text("",key="-TEXT_CPU-",size=(40,2),font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0))],
            [sg.Combo(palabras_maquina,key="-PALABRAS_CPU-",default_value="Palabras ingresadas:",size=(25,1),readonly=True)],
            [sg.T("Puntos:",font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0)),sg.T(puntos_ma,key="-PUNTOS_CPU-",size=(4,1),font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0))]
        ]

        datos_jugador = [
            [sg.Text("",key="-TEXT_JUGADOR-",size=(40,2),font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0))],
            [sg.Combo(palabras_usuario,key="-PALABRAS_JUGADOR-",default_value="Palabras ingresadas:",size=(25,1),readonly=True)],
            [sg.Text("Puntos:",font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0)),sg.T(puntos_jug,key="-PUNTOS_JUGADOR-",size=(4,1),font=("Arial black",10),text_color="black",background_color="#6AB2E5",pad=(0,0))]
        ]

        #COLUMNA DE LA CPU
        cpu = [
            [sg.Image(r"Data/Images/Juego/Avatar-CPU.png",background_color="#6AB2E5",pad=(5,5)),sg.Column(datos_cpu,background_color="#6AB2E5",pad=((0,0),(25,0)))],
            [sg.Column(layout_fichasM,background_color="#6AB2E5")]
        ]

        #COLUMNA DEL JUGADOR
        jugador = [
            [sg.Image(r"Data/Images/Juego/Avatar-jugador.png",background_color="#6AB2E5",pad=(5,5)),sg.Column(datos_jugador,background_color="#6AB2E5",pad=((0,0),(25,0)))],
            [sg.Column(layout_fichasJ,background_color="#6AB2E5")]
        ]
        ...
        barra_datos = [
            [sg.Image(r"Data/Images/Juego/titulo-barra-datos.png",background_color="#2781D3",pad=((30,30),(5,0)))],
            [sg.Column(armar_clases(nivel, clases_validas, 'l'),background_color="#2781D3",pad=((5,0),(0,5)))],
            [sg.Column(jugador,background_color="#6AB2E5",pad=((5,0),(0,0)))],
            [sg.Column(botones, background_color="#2781D3")],
            [sg.Column(cpu,background_color="#6AB2E5",pad=((5,0),(0,0)))],
            [sg.Column(tiempo, background_color="#2781D3",pad=((0,0),(5,0)))]
        ]

        #VENTANA COMPLETA
        layout = [
            [sg.Column(layout_tablero,background_color="#40B7C9",pad=(0,0)),
            sg.Column(barra_datos, background_color="#2781D3",pad=(0,0))]
        ]


        window = sg.Window("ScrabbleAR - En partida",size=(1045,670),background_color="#40B7C9",margins=(0,0)).Layout(layout)
